...
var xConfirm=function(msg,fn){
	var dom ='<div class="confirm-window">\
				<div class="confirm-heading">消息提示</div>\
				<div class="confirm-body">\
					<div class="confirm-body-txt">'+msg+'</div>\
				</div>\
				<div class="confirm-footer">\
					<div class="confirm-btn confirm-cancle-btn">取消</div>\
					<div class="confirm-btn confirm-confirm-btn">确定</div>\
				</div>\
			</div>';
